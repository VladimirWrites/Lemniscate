...
class RoundScribbleProgressView : BaseRouletteProgressView {
    ...
    override fun getGraphY(t: Double): Float =
            (viewSize.size / sizeFactor * (radiusSum * Math.cos(t) - rouletteCurveSettings.distanceFromCenter * Math.sin(radiusSum / rouletteCurveSettings.radiusMoving * t))).toFloat()
